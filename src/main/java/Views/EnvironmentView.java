...
/**
 * EnvironmentView is the visual representation of the entire system and is the module that interacts directly with the user.
 * Any operation requested by the user is then passed on to the {@link Controllers.EnvironmentController}
 */
public class EnvironmentView extends JFrame {
    ...
    /**
     * Method used to pass on the {@link JButton} listener responsibility to its caller.
     * @param listenForUser Listener for the button that selects the {@link UserProfileModel} before starting the simulation
     */
    ...
    /**
     * Method used to pass on the {@link JButton} listener responsibility to its caller.
     * @param listenForLocation Listener for the button that selects the selected {@link UserProfileModel} location before starting the simulation
     */
     ...
     * @param listenForUserDropDown Listener for the dropdown button that selects between different {@link UserProfileModel}
     */
    ...
    /**
     * Method used to pass on the {@link JComboBox} listener responsibility to its caller.
     * @param listenForUserRoomDropDown Listener for the dropdown button that between different {@link Room} for the currently selected {@link UserProfileModel}
     */
     ...
     * @param isCurrentUser boolean indicating whether a current user is set in the {@link Models.EnvironmentModel}
     */
     ...
     * @param isCurrentRoom boolean indicating whether the currently selected {@link UserProfileModel} is in the passed in {@link Room}
     */
     ...
     * @param index integer value representing the index position of the {@link Room} within the Dropdown
     */
    ...
    /**
     * Sets Room Dropdown menu to the specified {@link Room}
     * NOTE: This only works if the passed in {@link Room} object has the same reference as the
     * {@link Room} object that is contained within the Dropdown menu
     ...
     * @param formatter Object that performs the conversion between the user selecting a date on the UI via a DatePicker
     * to a useable String format to be stored in the {@link Models.EnvironmentModel}.
     * The core logic of {@param formatter} is found in {@link Controllers.EnvironmentController}
     */
    ...
    /**
     * Gets the value from the {@link JSpinner} module used to change the Time of the simulated environment
    ...
    /**
     * Creates an interface that allows the Simulator user to create new profiles
     * The user needs to specify the new profile's name as well as the {@link profileType}. The latter is displayed
     */
    ...
    /**
     * Called after a user confirms the create of a user.
     * This method creates a new {@link UserProfileModel} with the completed fields
     * @return A {@link UserProfileModel} containing the attributes specified in {@link #userCreationWindow()}
     */
