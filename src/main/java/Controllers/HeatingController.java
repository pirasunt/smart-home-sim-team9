...
public class HeatingController implements AwayChangeObserver {
  ...
  /**
   * Instantiates a new Heating controller.
   *
   * @param m the m
   * @param v the v
   */
  ...
  /**
   * Gets static heating model.
   *
   * @return the static heating model
   */
  public static HeatingModel getStaticHeatingModel() {
    return sHeatingModel;
  }

  /** Update time period temps. */
  ...
  private void createHeatingComponents() {
    ...
    for (int i = 0; i < rooms.size(); i++) {
      ...
      int index = i;
      editRoomTempBtn.addActionListener(
          new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                    ...
                    public void actionPerformed(ActionEvent e) {
                      ...
                      if (ert.getYesRadioButton().isSelected()) {
                        if (!r.isTempOverriden()) {
                          ...
                          r.getRoomTempLabel()
                              .setText(r.getRoomTempLabel().getText() + " [OVERRIDDEN]");
                        }
                        ...
                        if (r.isTempOverriden()) {
                          ...
                          for (HeatingZone hz : sHeatingModel.getHeatingZones()) {
                            for (Room room : hz.getRooms()) {
                              if (r.getId() == room.getId()) zoneTemp = hz.getTemperature();
                            }
                          }
                        }
              ...
              ert.addTurnOffOverrideListener(
                  new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
      ...
      editBtn.addActionListener(
          new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              editZoneDiag.addEditCancelButtonListener(
                  new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
              ...
              editZoneDiag.addEditConfirmButtonListener(
                  new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
    ...
    private class ZoneConfirmButtonListener implements ActionListener {
      ...
      public void actionPerformed(ActionEvent e) {
        if (heatZoneDialog.getZoneName().length() > 0 && selectedRoomsMemory.size() > 0) {
          ...
          heatingModel.createHeatingZone(
              selectedRooms,
              heatZoneDialog.getZoneName(),
  ...
  private class SeasonDateFormatter extends JFormattedTextField.AbstractFormatter {
    ...
    /**
     * Instantiates a new Season date formatter.
     *
     * @param type the type
     */
