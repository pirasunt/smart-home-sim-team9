        ...
        for (Room r : house.getRooms()) {
            if (r.getLeftWall().getType() == WallType.DOOR) {
                ...
                for (Room r2 : house.getRooms()) {
                    if (r2.getId() == otherId && ((RoomWall)r2.getRightWall()).getConnectedRoom() != roomId) return false;
                }
            }
                ...
                for (Room r2 : house.getRooms()) {
                    if (r2.getId() == otherId && ((RoomWall)r2.getTopWall()).getConnectedRoom() != roomId) return false;
                }
            }
                ...
                for (Room r2 : house.getRooms()) {
                    if (r2.getId() == otherId && ((RoomWall)r2.getLeftWall()).getConnectedRoom() != roomId) return false;
                }
            }
                ...
                for (Room r2 : house.getRooms()) {
                    if (r2.getId() == otherId && ((RoomWall)r2.getBottomWall()).getConnectedRoom() != roomId) return false;
                }
            }
        }
